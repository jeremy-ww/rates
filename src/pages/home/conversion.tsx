...
export default function Conversion (props: {
  ...
  const onValuesChange = useCallback((changedValues: Partial<{ source: number, target: number }>) => {
  ...
  return (
    <section>
      <Form initialValues={{ source: 1, target: props.rate }} onValuesChange={onValuesChange} form={form}>
